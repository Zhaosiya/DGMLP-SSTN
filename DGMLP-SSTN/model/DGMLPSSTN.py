...
from model.block.sstn import SSTN  # 导入新创建的SSTN模块
...
class Model(nn.Module):
    def __init__(self, args):
        ...
        # 添加SSTN模块
        self.mlp_gcn = Mlp_gcn(args.layers, args.channel, args.d_hid, args.token_dim, self.A, length=args.n_joints,
                               frames=args.frames)
